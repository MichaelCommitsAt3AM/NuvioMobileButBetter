            ...
            Box(
                Modifier.size(320.dp, 180.dp)
                    ...
                    .playerSurfaceDragGestures(
                        ...
                        playerControlsLockedState = unlocked,
                        gestureSwipeSeekEnabledState = rememberUpdatedState(true),
                        gestureBrightnessEnabledState = rememberUpdatedState(true),
                        gestureVolumeEnabledState = rememberUpdatedState(true),
